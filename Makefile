LANGUAGE_NAME := tree-sitter-unrealscript
HOMEPAGE_URL := https://github.com/shrimpza/tree-sitter-unrealscript
VERSION := 0.3.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/unrealscript '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/unrealscript
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/unrealscript
